...
namespace auxilo {
  ...
  public static partial class Protocol {
    ...
    internal static pbd::MessageDescriptor internal__static_auxilo_SensDataList__Descriptor;
    internal static pb::FieldAccess.FieldAccessorTable<global::auxilo.SensDataList, global::auxilo.SensDataList.Builder> internal__static_auxilo_SensDataList__FieldAccessorTable;
    ...
    static Protocol() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "AyACKAgi8AEKB01lc3NhZ2USGgoScmVjZWl2ZXJEZXZpY2VOYW1lGAEgAigJ" + 
          "EhgKEHNlbmRlckRldmljZU5hbWUYAiACKAkSLAoOc2Vuc29yRGF0YUxpc3QY" + 
          "AyABKAsyFC5hdXhpbG8uU2Vuc0RhdGFMaXN0EiUKA3FyeRgEIAEoCzIYLmF1" + 
          "eGlsby5RdWVyeU1lc3NhZ2VMaXN0Ei0KDmRldmljZV9jb21tYW5kGAUgASgL" + 
          "MhUuYXV4aWxvLkRldmljZUNvbW1hbmQSKwoNZGV2aWNlX3N0YXR1cxgGIAEo" + 
          "CzIULmF1eGlsby5EZXZpY2VTdGF0dXMiNAoKRGV2aWNlTGlzdBImCgpkZXZp" + 
          "Y2VMaXN0GAEgAygLMhIuYXV4aWxvLkRldmljZUluZm8idwoKRGV2aWNlSW5m" + 
          "bxINCgVib3hJRBgBIAIoCRIQCghkZXZpY2VJRBgCIAIoCRITCgtkZXNjcmlw" + 
          "dGlvbhgDIAEoCRIRCglhbGlhc05hbWUYBCABKAkSIAoEdHlwZRgFIAIoDjIS" + 
          "LmF1eGlsby5kZXZpY2VUeXBlIjcKEFF1ZXJ5TWVzc2FnZUxpc3QSIwoFcXVl" + 
          "cnkYASADKAsyFC5hdXhpbG8uUXVlcnlNZXNzYWdlIjQKDFF1ZXJ5TWVzc2Fn" + 
          "ZRIQCghzZW5zb3JJRBgBIAIoCRISCgpsYXRlc3REYXRlGAIgASgJIjcKDFNl" + 
          "bnNEYXRhTGlzdBInCgpzZW5zb3JEYXRhGAEgAygLMhMuYXV4aWxvLkRhdGFN" + 
          "ZXNzYWdlIkIKC0RhdGFNZXNzYWdlEhIKCmhhcmR3YXJlSUQYASACKAkSDAoE" + 
          "ZGF0YRgCIAIoAhIRCgl0aW1lU3RhbXAYAyACKAkiXAoNRGV2aWNlQ29tbWFu" + 
          "ZBIQCghkZXZpY2VJRBgBIAIoCRImCglzZXRTdGF0dXMYAiABKA4yEy5hdXhp" + 
          "bG8uZGV2aWNlU3RhdGUSEQoJZ2V0U3RhdHVzGAMgASgIIkUKDERldmljZVN0" + 
          "YXR1cxIQCghkZXZpY2VJRBgBIAIoCRIjCgZzdGF0dXMYAiACKA4yEy5hdXhp" + 
          "bG8uZGV2aWNlU3RhdGUqOwoKZGV2aWNlVHlwZRIOCgpzZW5zb3JUZW1wEAES" + 
          "DgoKZGV2aWNlTmV4YRACEg0KCXNlbnNvclBJUhADKisKC2RldmljZVN0YXRl" + 
          "EgYKAm9uEAESBwoDb2ZmEAISCwoHdW5rbm93bhADQhwKCHByb3RvYnVmQhBQ" + 
          "cm90b2J1Zk1lc3NhZ2Vz");
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_auxilo_DeviceList__Descriptor = Descriptor.MessageTypes[2];
        ...
        internal__static_auxilo_DeviceInfo__Descriptor = Descriptor.MessageTypes[3];
        ...
        internal__static_auxilo_QueryMessageList__Descriptor = Descriptor.MessageTypes[4];
        internal__static_auxilo_QueryMessageList__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::auxilo.QueryMessageList, global::auxilo.QueryMessageList.Builder>(internal__static_auxilo_QueryMessageList__Descriptor,
                new string[] { "Query", });
        internal__static_auxilo_QueryMessage__Descriptor = Descriptor.MessageTypes[5];
        ...
        internal__static_auxilo_SensDataList__Descriptor = Descriptor.MessageTypes[6];
        internal__static_auxilo_SensDataList__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::auxilo.SensDataList, global::auxilo.SensDataList.Builder>(internal__static_auxilo_SensDataList__Descriptor,
                new string[] { "SensorData", });
        internal__static_auxilo_DataMessage__Descriptor = Descriptor.MessageTypes[7];
        ...
        internal__static_auxilo_DeviceCommand__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::auxilo.DeviceCommand, global::auxilo.DeviceCommand.Builder>(internal__static_auxilo_DeviceCommand__Descriptor,
                new string[] { "DeviceID", "SetStatus", "GetStatus", });
  ...
  public sealed partial class Message : pb::GeneratedMessage<Message, Message.Builder> {
    ...
    private global::auxilo.SensDataList sensorDataList_;
    public bool HasSensorDataList {
      get { return hasSensorDataList; }
    }
    public global::auxilo.SensDataList SensorDataList {
      get { return sensorDataList_ ?? global::auxilo.SensDataList.DefaultInstance; }
    }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<Message, Builder> {
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 26: {
              global::auxilo.SensDataList.Builder subBuilder = global::auxilo.SensDataList.CreateBuilder();
      ...
      public Builder SetSensorDataList(global::auxilo.SensDataList value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
      ...
      public Builder SetSensorDataList(global::auxilo.SensDataList.Builder builderForValue) {
      ...
      public Builder MergeSensorDataList(global::auxilo.SensDataList value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        if (result.hasSensorDataList &&
            result.sensorDataList_ != global::auxilo.SensDataList.DefaultInstance) {
            result.sensorDataList_ = global::auxilo.SensDataList.CreateBuilder(result.sensorDataList_).MergeFrom(value).BuildPartial();
        } else {
          result.sensorDataList_ = value;
        }
        result.hasSensorDataList = true;
  ...
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
  public sealed partial class SensDataList : pb::GeneratedMessage<SensDataList, SensDataList.Builder> {
    private SensDataList() { }
    private static readonly SensDataList defaultInstance = new SensDataList().MakeReadOnly();
    private static readonly string[] _sensDataListFieldNames = new string[] { "sensorData" };
    private static readonly uint[] _sensDataListFieldTags = new uint[] { 10 };
    public static SensDataList DefaultInstance {
      get { return defaultInstance; }
    }
    
    public override SensDataList DefaultInstanceForType {
      get { return DefaultInstance; }
    }
    
    protected override SensDataList ThisMessage {
      get { return this; }
    }
    
    public static pbd::MessageDescriptor Descriptor {
      get { return global::auxilo.Protocol.internal__static_auxilo_SensDataList__Descriptor; }
    }
    
    protected override pb::FieldAccess.FieldAccessorTable<SensDataList, SensDataList.Builder> InternalFieldAccessors {
      get { return global::auxilo.Protocol.internal__static_auxilo_SensDataList__FieldAccessorTable; }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      int size = SerializedSize;
      string[] field_names = _sensDataListFieldNames;
    ...
    public static SensDataList ParseFrom(pb::ByteString data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static SensDataList ParseFrom(pb::ByteString data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static SensDataList ParseFrom(byte[] data) {
      return ((Builder) CreateBuilder().MergeFrom(data)).BuildParsed();
    }
    public static SensDataList ParseFrom(byte[] data, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(data, extensionRegistry)).BuildParsed();
    }
    public static SensDataList ParseFrom(global::System.IO.Stream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SensDataList ParseFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static SensDataList ParseDelimitedFrom(global::System.IO.Stream input) {
      return CreateBuilder().MergeDelimitedFrom(input).BuildParsed();
    }
    public static SensDataList ParseDelimitedFrom(global::System.IO.Stream input, pb::ExtensionRegistry extensionRegistry) {
      return CreateBuilder().MergeDelimitedFrom(input, extensionRegistry).BuildParsed();
    }
    public static SensDataList ParseFrom(pb::ICodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SensDataList ParseFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    private SensDataList MakeReadOnly() {
    ...
    public override Builder ToBuilder() { return CreateBuilder(this); }
    public override Builder CreateBuilderForType() { return new Builder(); }
    public static Builder CreateBuilder(SensDataList prototype) {
      return new Builder(prototype);
    }
    
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
    public sealed partial class Builder : pb::GeneratedBuilder<SensDataList, Builder> {
      protected override Builder ThisBuilder {
        get { return this; }
      }
      public Builder() {
      ...
      internal Builder(SensDataList cloneFrom) {
        result = cloneFrom;
        resultIsReadOnly = true;
      }
      
      private bool resultIsReadOnly;
      private SensDataList result;
      
      private SensDataList PrepareBuilder() {
        if (resultIsReadOnly) {
          SensDataList original = result;
          result = new SensDataList();
          resultIsReadOnly = false;
          MergeFrom(original);
        }
        return result;
      ...
      protected override SensDataList MessageBeingBuilt {
        get { return PrepareBuilder(); }
      }
      ...
      public override pbd::MessageDescriptor DescriptorForType {
        get { return global::auxilo.SensDataList.Descriptor; }
      }
      
      public override SensDataList DefaultInstanceForType {
        get { return global::auxilo.SensDataList.DefaultInstance; }
      }
      
      public override SensDataList BuildPartial() {
        if (resultIsReadOnly) {
          return result;
        }
        resultIsReadOnly = true;
      ...
      public override Builder MergeFrom(pb::IMessage other) {
        if (other is SensDataList) {
          return MergeFrom((SensDataList) other);
        } else {
          base.MergeFrom(other);
          return this;
        }
      ...
      public override Builder MergeFrom(SensDataList other) {
        if (other == global::auxilo.SensDataList.DefaultInstance) return this;
        PrepareBuilder();
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          if(tag == 0 && field_name != null) {
            int field_ordinal = global::System.Array.BinarySearch(_sensDataListFieldNames, field_name, global::System.StringComparer.Ordinal);
            if(field_ordinal >= 0)
              tag = _sensDataListFieldTags[field_ordinal];
            else {
              if (unknownFields == null) {
                unknownFields = pb::UnknownFieldSet.CreateBuilder(this.UnknownFields);
              }
  ...
  public sealed partial class DeviceCommand : pb::GeneratedMessage<DeviceCommand, DeviceCommand.Builder> {
    ...
    private static readonly string[] _deviceCommandFieldNames = new string[] { "deviceID", "getStatus", "setStatus" };
    private static readonly uint[] _deviceCommandFieldTags = new uint[] { 10, 24, 16 };
    ...
    public const int GetStatusFieldNumber = 3;
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasSetStatus) {
        output.WriteEnum(2, field_names[2], (int) SetStatus, SetStatus);
      }
      if (hasGetStatus) {
        output.WriteBool(3, field_names[1], GetStatus);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public override int SerializedSize {
      get {
        ...
        if (hasGetStatus) {
          size += pb::CodedOutputStream.ComputeBoolSize(3, GetStatus);
        }
        size += UnknownFields.SerializedSize;
        memoizedSerializedSize = size;
        return size;
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<DeviceCommand, Builder> {
      ...
      public override Builder MergeFrom(pb::ICodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (input.ReadTag(out tag, out field_name)) {
          ...
          switch (tag) {
            ...
            case 24: {
              result.hasGetStatus = input.ReadBool(ref result.getStatus_);
              break;
            }
          }
        }
      ...
      public bool HasGetStatus {
        get { return result.hasGetStatus; }
      }
      public bool GetStatus {
        get { return result.GetStatus; }
        set { SetGetStatus(value); }
      }
      public Builder SetGetStatus(bool value) {
        PrepareBuilder();
        result.hasGetStatus = true;
        result.getStatus_ = value;
        return this;
      }
      public Builder ClearGetStatus() {
        PrepareBuilder();
        result.hasGetStatus = false;
        result.getStatus_ = false;
        return this;
      }
    }
